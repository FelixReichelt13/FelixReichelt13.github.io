...
2. Investigate **genetic and environmental covariance between stress exposures and personality traits** using twin- and family-based designs.
3. Study **gene × stress-exposure and gene × stress-response interplay in cardiometabolic outcomes**.
...
### Personality–Stress Exposure Covariance

Using the **Netherlands Twin Register**, I investigate why personality traits and stressful life events co-occur through twin- and family-based variance decomposition, genetic and environmental correlation analyses, and comparisons of dependent and independent stressful life events.

### Polygenic Risk, Stress, and Cardiometabolic Health

I investigate how **polygenic liability and stress exposures or stress responses jointly relate to cardiometabolic outcomes**. Current work includes polygenic prediction and integrative risk modelling, including cardiovascular risk markers such as **coronary artery calcification in the ImaLife subcohort**.

### Causal Inference and Molecular Epidemiology

During my MSc research at the **Dutch Cancer Institute (NKI)**, I used **Mendelian randomization** to investigate causal effects of breast cancer risk factors across molecular breast cancer subtypes.
...
**2025:** Panel contribution, *“Innovating Stress Research: from Lab to Real Life,”* ISCOMS, Groningen.

**2025:** Poster presentation, **International Genetic Epidemiology Society Conference**, Cologne.

**2024:** Oral presentation, **WEON Annual Netherlands Epidemiology Congress**, Utrecht.

**2024:** Poster presentation, **Stress-in-Action Consortium event at KNAW**, Amsterdam.
...
**Quantitative and statistical genetics:** twin- and family-based heritability modelling, variance decomposition, genetic correlation estimation, PRS, GWAS-derived summary statistics, and multi-trait approaches.
...
**Programming and infrastructure:** R, Python, reproducible version-controlled workflows, large-scale cohort data, and HPC workflows.
...
I have completed **75+ ECTS of doctoral training**. Specialist training includes Behavioral Genetics at Vrije Universiteit Amsterdam, GWAS prediction of complex phenotypes at Aarhus University, Mendelian Randomization at the University of Cambridge, and Data Science and AI in Health at the University of Groningen.
...
**Centogene, Rostock:** rare disease and oncogenetic diagnostics, DNA extraction, biobanking, and genetic testing workflows.
